...
model_urls = {
    "vit_b_16": "https://dl.fbaipublicfiles.com/dino/dino_vitbase16_pretrain/dino_vitbase16_pretrain.pth",
    "vit_b_8": "https://dl.fbaipublicfiles.com/dino/dino_vitbase8_pretrain/dino_vitbase8_pretrain.pth",
    "vit_s_8": "https://dl.fbaipublicfiles.com/dino/dino_deitsmall8_pretrain/dino_deitsmall8_pretrain.pth",
    "vit_s_16": "https://dl.fbaipublicfiles.com/dino/dino_deitsmall16_pretrain/dino_deitsmall16_pretrain.pth"
}


vit_settings = {    
    'vit_s_8': [8, 12, 384, 6],   #[patch_size, number_of_layers, embed_dim, heads]
    'vit_s_16': [16, 12, 384, 6],
    'vit_b_16': [16, 12, 768, 12]
}
...
class ViT(nn.Module):
    def __init__(self, model_name, image_size: int = 224) -> None:
        super().__init__()
