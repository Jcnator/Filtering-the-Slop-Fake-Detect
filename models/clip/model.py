...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        # print("         positional x", x.shape)
        x = self.ln_pre(x)
        # print("         ln pre", x.shape)
        ...
        # print("         before ln post x", x.shape)
        # print("         feat getting post", x[:, 0, :].shape)
        out['before ln post'] = x
        x = self.ln_post(x[:, 0, :])
        # print("         ln post x", x.shape)
...
class CLIP(nn.Module):
    ...
    def forward(self, image, text):
        print("    Forward Clip", image.shape)
